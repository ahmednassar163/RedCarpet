...
import com.nassar.man.android.redcarpet.extras.Review;
import com.nassar.man.android.redcarpet.extras.Trailer;
        ...
        protected List<Trailer> doInBackground(String... params) {
            ...
            try {
                ...
                Uri builtUri = Uri.parse(BASE_URL).buildUpon()
                        .appendQueryParameter(API_KEY_PARAM, getString(R.string.THE_MOVIE_DB_API_KEY))
                        .build();
